...
import ch.bfh.sws.eadj.hr.Address;
...
public abstract class AbstractHrTest {

    protected static final Logger LOGGER = java.util.logging.Logger.getLogger(AbstractHrTest.class.getName());
